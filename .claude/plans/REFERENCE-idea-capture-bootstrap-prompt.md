...
1. `.claude/docs/idea-capture-specs.md` — Consolidated spec covering:
   - Markdown file format, parsing anchors, mutation rules
   - ULID format, metadata structure, delimiter rules
   - CLI integration patterns and JSON schemas
   - High-level vision and phasing

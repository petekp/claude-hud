...
2. Launch the app. If hooks aren't configured, you'll see a setup card with a "Fix All" button that automatically configures your `~/.claude/settings.json`.
   ...
   **Or manually** add hooks to your Claude Code settings (`~/.claude/settings.json`):
   ...
   {
     "hooks": {
       "SessionStart": [{ "hooks": [{ "type": "command", "command": "CAPACITOR_DAEMON_ENABLED=1 CAPACITOR_DAEMON_LOCK_HEALTH=auto $HOME/.local/bin/hud-hook handle", "async": true, "timeout": 30 }] }],
       "SessionEnd": [{ "hooks": [{ "type": "command", "command": "CAPACITOR_DAEMON_ENABLED=1 CAPACITOR_DAEMON_LOCK_HEALTH=auto $HOME/.local/bin/hud-hook handle" }] }],
       "UserPromptSubmit": [{ "hooks": [{ "type": "command", "command": "CAPACITOR_DAEMON_ENABLED=1 CAPACITOR_DAEMON_LOCK_HEALTH=auto $HOME/.local/bin/hud-hook handle", "async": true, "timeout": 30 }] }],
       "PreToolUse": [{ "matcher": "*", "hooks": [{ "type": "command", "command": "CAPACITOR_DAEMON_ENABLED=1 CAPACITOR_DAEMON_LOCK_HEALTH=auto $HOME/.local/bin/hud-hook handle", "async": true, "timeout": 30 }] }],
       "PostToolUse": [{ "matcher": "*", "hooks": [{ "type": "command", "command": "CAPACITOR_DAEMON_ENABLED=1 CAPACITOR_DAEMON_LOCK_HEALTH=auto $HOME/.local/bin/hud-hook handle", "async": true, "timeout": 30 }] }],
       "PermissionRequest": [{ "matcher": "*", "hooks": [{ "type": "command", "command": "CAPACITOR_DAEMON_ENABLED=1 CAPACITOR_DAEMON_LOCK_HEALTH=auto $HOME/.local/bin/hud-hook handle", "async": true, "timeout": 30 }] }],
       "Stop": [{ "hooks": [{ "type": "command", "command": "CAPACITOR_DAEMON_ENABLED=1 CAPACITOR_DAEMON_LOCK_HEALTH=auto $HOME/.local/bin/hud-hook handle", "async": true, "timeout": 30 }] }],
       "PreCompact": [{ "hooks": [{ "type": "command", "command": "CAPACITOR_DAEMON_ENABLED=1 CAPACITOR_DAEMON_LOCK_HEALTH=auto $HOME/.local/bin/hud-hook handle", "async": true, "timeout": 30 }] }],
       "Notification": [{ "hooks": [{ "type": "command", "command": "CAPACITOR_DAEMON_ENABLED=1 CAPACITOR_DAEMON_LOCK_HEALTH=auto $HOME/.local/bin/hud-hook handle", "async": true, "timeout": 30 }] }]
     }
   }
   ```
